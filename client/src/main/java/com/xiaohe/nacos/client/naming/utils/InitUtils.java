...
import com.xiaohe.nacos.api.SystemPropertyKeyConst;
import com.xiaohe.nacos.api.common.Constants;
import com.xiaohe.nacos.api.selector.ExpressionSelector;
import com.xiaohe.nacos.api.selector.NoneSelector;
import com.xiaohe.nacos.api.selector.SelectorType;
import com.xiaohe.nacos.client.env.NacosClientProperties;
import com.xiaohe.nacos.client.env.SourceType;
import com.xiaohe.nacos.client.utils.*;
...
public class InitUtils {
     ...
     *
     * <p>
     * 这是源码中的中文注释，不是我自己加的，我给搬运过来了
     * 子类实现类中的静态代码串中已经向Jackson进行了注册，但是由于classloader的原因，只有当该子类被使用的时候，才会加载该类。这可能会导致Jackson先进性反序列化，再注册子类，从而导致反序列化失败。
     * </p>
     */
